...
const HeroSection = () => {
  return (
    <div className="w-screen h-full min-h-screen bg-[url('./src/assets/images/hero-bg.jpg')] bg-cover bg-bottom bg-no-repeat flex flex-col justify-center items-center px-[20px] mb-[90px]">
